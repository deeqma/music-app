...
import { clearToken } from '../../core/auth/authToken'
import type { ErrorResponse, UserRole } from '../../core/auth/contracts'
    ...
    <div className="auth-page">
      <div className="auth-page__card">
        ...
        <form className="auth-page__form" onSubmit={handleSubmit}>
          ...
          <div className="auth-page__field">
            <label className="auth-page__label" htmlFor="reg-role-group">Role</label>
            <div id="reg-role-group" className="auth-page__role-group">
              {ROLES.map(r => (
                <button
                  key={r}
                  type="button"
